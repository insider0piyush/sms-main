...
<html>
    ...
    <body id="grad_back">
        ...
        <?php
            ...
            $createTable = "CREATE TABLE $FACULTY_ADD($FACULTY_MNO BIGINT PRIMARY KEY,
                            $FACULTY_NAME TEXT,$FACULTY_EMAIL TEXT UNIQUE,$FACULTY_PASSWORD TEXT,$FACULTY_QUALIFICATION TEXT)";
